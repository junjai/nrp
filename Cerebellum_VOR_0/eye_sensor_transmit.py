...
@nrp.MapCSVRecorder("recorder_image", filename="target_position.csv", headers=["time", "x", "ae"])
def eye_sensor_transmit(t, camera, positive_error, negative_error, recorder_image):
    import math
    ...
    recorder_image.record_entry(t, xy_ball_pos[0], ae_ball_pos[0])
